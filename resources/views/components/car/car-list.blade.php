            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="#" class="btn btn-danger btn-sm" data-toggle="modal"
                        data-target="#deletecar{{ $car->plat_number }}modal">Delete</a>
                </td>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <p>
                                    Apakah anda yakin ingin menghapus Car <strong>{{ $car->name }}</strong> {{ $type
            ...
            <tr>
                <td colspan="8">
                    <p class="font-weight-bold text-center text-monospace">
                       {{ $type === 'trash' ? ' Deleted Car Data Empty ' : '' }}
                    </p>
                </td>
            </tr>
            @endforelse
