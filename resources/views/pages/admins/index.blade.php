...
@section('title', 'Mingalar Car Rental Admin')

@section('content')
<h1>Mingalar Car Rental</h1>
...
<div class="row justify-content-center">
    <div class="col-md-10">
                        ...
                        <form action="{{ route('admins.index') }}">
                            <div class="input-group mb-3">
                                <input type="text" name="search" class="form-control"
                                    placeholder="Cari berdasarkan Name atau email" value="{{ request()->search }}">
        ...
        <a href="{{ route('admins.create') }}" class="btn btn-primary btn-block mb-1">Add Admin</a>
        ...
        <div class="table-responsive">
            <table class="table table-hover table-bordered text-center mt-2">
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="6">
                            <p class="font-weight-bold text-center text-monospace">Data admin tidak Available</p>
                        </td>
                    </tr>
                    @endforelse
                </tbody>
